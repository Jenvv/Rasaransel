...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Bulan Mei 2024 pada 09.54
...
(108, 1, 38, '2024-05-14', '19500', 'Mempawah Timur,Jln Bardan Nad', '10000', 0, 0, 2),
...
--
ALTER TABLE `pesanan`
  MODIFY `id_pesanan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;
