...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Bulan Mei 2024 pada 22.45
...
(55, 38, 'soi', 1, '0', '2024-05-11 07:25:43'),
(72, 38, 'asdasd', 1, '0', '2024-05-13 12:03:37'),
(73, 38, 'sadar', 1, '0', '2024-05-13 12:03:55'),
(74, 38, '0', 1, 'mang eak', '2024-05-13 12:04:02');
...
(101, 0, 38, '2024-05-13', '6200', 'Mempawah Timur,Jln Bardan Nad', '5000', 1, 0, 1),
(103, 2, 38, '2024-05-13', '20000', 'Mempawah Timur,Jln Bardan Nad', '10000', 1, 0, 1),
(104, 1, 38, '2024-05-13', '19500', 'Mempawah Timur,Jln Bardan Nad', '10000', 0, 0, 2),
(105, 2, 38, '2024-05-13', '20000', 'Mempawah Timur,Jln Bardan Nad', '10000', 1, 0, 1);
...
INSERT INTO `user` (`id_user`, `nama`, `username`, `password`, `no_hp`, `alamat`, `is_active`, `level_user`) VALUES
(1, 'Toko Petir', 'admin', '$2y$10$swT1BxTARnJKC/rKMm13vOtIFgbF.IlnG9QkBD6RFyZMWUht7ijLq', '089887656545', 'Kuningan', 0, 2),
(3, 'ALAW', 'pemilik', '$2y$10$swT1BxTARnJKC/rKMm13vOtIFgbF.IlnG9QkBD6RFyZMWUht7ijLq', '089987656543', 'Kuningan, Jawa Barat', 0, 2);
...
--
ALTER TABLE `chatting`
  MODIFY `id_chatting` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
