...
|
*/
$config['base_url'] = 'http://localhost/rasaransel/';
...
$config['sess_driver'] = 'database';
$config['sess_cookie_name'] = 'ci_session';
$config['sess_expiration'] = 7200; // Sesi berakhir setelah 2 jam
$config['sess_save_path'] = 'ci_sessions'; // Nama tabel sesi
$config['sess_match_ip'] = TRUE; // Cocokkan IP untuk keamanan tambahan
$config['sess_time_to_update'] = 300; // Update ID sesi setiap 5 menit
$config['sess_regenerate_destroy'] = TRUE; // Hapus sesi lama setelah regenerasi
