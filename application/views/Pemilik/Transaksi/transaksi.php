    ...
    <div class="container-fluid p-0">
        <div class="row mb-2 mb-xl-3">
            <div class="col-auto d-none d-sm-block">
                <h3><strong>Monitoring</strong> User</h3>
            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="table-action">
                                        ...
                                        <a href="<?= base_url('Pemilik/cTransaksi/transaksi/' . $value->id_user); ?>"
                                            style="color: white;" class="btn btn-secondary"><i class="align-middle"
