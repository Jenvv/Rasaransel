<main class="content">
	<div class="container-fluid p-0">
		...
		<h1 class="h3 mb-3">Detail Ulasan</h1>
						...
						?>
								<div class="media">
									<div class="media-body">
										<small class="float-right text-navy"><?= $value->created_at ?></small>
										<strong><?= $value->nama ?></strong><br />
							...
							?>
							<form action="<?= base_url('Admin/cChatting/balasan/' . $id_layanan) ?>" method="POST">
