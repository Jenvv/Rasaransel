		    			...
		    			<div class="col-md-8 col-xl-9">
		    				<div class="card">
		    					...
		    					<div class="card-body h-100">
		    						...
		    						<div class="media">
		    							<img src="<?= base_url('asset/merchant/' . $users->photo) ?>" width="36" height="36" class="rounded-circle mr-2" alt="Vanessa Tucker">
		    						...
		    						<hr />
		    						<div class="media">
		    							<img src="<?= base_url('asset/merchant/' . $users->photo) ?>" width="36" height="36" class="rounded-circle mr-2" alt="Charles Hall">
		    							<div class="media-body">
		    						...
		    						<hr />
		    						<div class="media">
		    							<img src="<?= base_url('asset/merchant/' . $users->photo) ?>" width="36" height="36" class="rounded-circle mr-2" alt="Christina Mason">
		    							<div class="media-body">
		    						...
		    						<hr />
		    						<div class="media">
		    							<img src="<?= base_url('asset/merchant/' . $users->photo) ?>" width="36" height="36" class="rounded-circle mr-2" alt="William Harris">
		    							<div class="media-body">
		    								...
		    								<div class="row no-gutters mt-1">
		    									<div class="col-6 col-md-4 col-lg-4 col-xl-3">
		    										<img src="<?= base_url('asset/merchant/' . $users->photo) ?>" class="img-fluid pr-2" alt="Unsplash">
		    									</div>
		    									<div class="col-6 col-md-4 col-lg-4 col-xl-3">
		    										<img src="<?= base_url('asset/merchant/' . $users->photo) ?>" class="img-fluid pr-2" alt="Unsplash">
		    									</div>
