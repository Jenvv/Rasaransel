...
<section class="bg-title-page flex-c-m p-t-160 p-b-80 p-l-15 p-r-15"
    style="background-image: url(<?= base_url('asset/pato-master/') ?>images/bg-title-page-02.jpg);">
                ...
                <form action="<?= base_url('Pelanggan/cHome/checkout') ?>" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
                                <input class="bo-rad-10 sizefull txt10 p-l-20" value="<?= $pelanggan->nama_plggn ?>"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
                                <input class="bo-rad-10 sizefull txt10 p-l-20" value="<?= $pelanggan->no_hp ?>"
                                    type="text" placeholder="Name" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
                                <select id="ongkir" name="kecamatan" class="bo-rad-10 sizefull txt10 p-l-20">
                                    ...
                                    <option data-vongkir="Rp. <?= number_format(10000) ?>"
                                        data-vtotal="Rp. <?= number_format($this->cart->total() + 10000) ?>"
                                        data-total="<?= $this->cart->total() +  10000 ?>" data-ongkir="10000"
                                        value="Pontianak Barat">Pontianak Barat</option>
                                    <option data-vongkir="Rp. <?= number_format(10000) ?>"
                                        data-vtotal="Rp. <?= number_format($this->cart->total() + 10000) ?>"
                                        data-total="<?= $this->cart->total() +  10000 ?>" data-ongkir="10000"
                                        value="Pontianak Kota">Pontianak Kota</option>
                                    <option data-vongkir="Rp. <?= number_format(5000) ?>"
                                        data-vtotal="Rp. <?= number_format($this->cart->total() + 5000) ?>"
                                        data-total="<?= $this->cart->total() +  5000 ?>" data-ongkir="5000"
                                        value="Pontianak Selatan">Pontianak Selatan</option>
                                    <option data-vongkir="Rp. <?= number_format(5000) ?>"
                                        data-vtotal="Rp. <?= number_format($this->cart->total() + 5000) ?>"
                                        data-total="<?= $this->cart->total() +  5000 ?>" data-ongkir="5000"
                                        value="Pontianak Tenggara">Pontianak Tenggara</option>
                                    <option data-vongkir="Rp. <?= number_format(5000) ?>"
                                        data-vtotal="Rp. <?= number_format($this->cart->total() + 5000) ?>"
                                        data-total="<?= $this->cart->total() +  5000 ?>" data-ongkir="5000"
                                        value="Pontianak Utara">Pontianak Utara</option>
                                    <option data-vongkir="Rp. <?= number_format(10000) ?>"
                                        data-vtotal="Rp. <?= number_format($this->cart->total() + 10000) ?>"
                                        data-total="<?= $this->cart->total() +  10000 ?>" data-ongkir="10000"
                                        value="Pontianak Timur">Pontianak Timur</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
                                <input class="bo-rad-10 sizefull txt10 p-l-20" value="<?= $pelanggan->alamat ?>"
                                    name="alamat_detail" type="text" placeholder="Name">
                            </div>
                        </div>
                    </div>
                    <div class="row">
