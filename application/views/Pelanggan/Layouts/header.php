...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="<?= base_url('asset/pato-master/') ?>vendor/bootstrap/css/bootstrap.min.css">
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css"
        href="<?= base_url('asset/pato-master/') ?>fonts/font-awesome-4.7.0/css/font-awesome.min.css">
    <!--===============================================================================================-->
                    ...
                    <div class="wrap_menu p-l-45 p-l-0-xl ">
                        <nav class="menu">
                            <ul class="main_menu">
                                ...
                                <?php } else { ?>
                                <li>
                                    <a href="<?= base_url('pelanggan/chome/view_cart') ?>" class="txt19">Keranjang <span
                                            class="badge badge-success"> <?= $cart ?></span></a>
                                </li>
                                <?php } ?>
                                <?php } ?>
                                <?php if ($this->session->userdata('id_pelanggan') == '') { ?>
                                <li>
                                    <a
                                        href="<?= base_url('pelanggan/clogin') ?>"><?= $this->session->userdata('nama_pelanggan'); ?>Login</a>
                                </li>
                                <li>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item"
                                            href="<?= base_url('pelanggan/cprofil') ?>"><?= $this->session->userdata('nama_pelanggan'); ?></a>
                                        <a class="dropdown-item"
                                            href="<?= base_url('pelanggan/cprofil/aktivitas') ?>">Aktivitas</a>
                                        <a class="dropdown-item" href="<?= base_url('pelanggan/cchatting') ?>">Chat</a>
                                        <a class="dropdown-item" style="color: #dc3545;"
                                            href="<?= base_url('pelanggan/cprofil/merchant') ?>">Daftar Merchant</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item"
                                            href="<?= base_url('pelanggan/clogin/Logout') ?>">Keluar</a>
                                    </div>
                                </li>
