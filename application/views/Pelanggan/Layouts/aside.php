...
<aside class="sidebar trans-0-4">
    ...
    <ul class="menu-sidebar p-t-95 p-b-70">
        ...
        <li class="t-center m-b-30">
            <a href="<?= base_url('pelanggan/chome/kontak') ?>" class="txt19">Pelayanan Pelanggan</a>
        </li>
        <li class="t-center m-b-30">
            <a href="blog.html" class="btn btn-danger text-white txt19" style="border-radius: 20px; "
