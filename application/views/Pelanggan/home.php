                    ...
                    <form action="<?= base_url('pelanggan/chome/cart') ?>" method="POST">
                        ...
                        <div class="blo1">
                            <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
                                <a href="#"><img style="width: 350px; height: 350px;"
                                        src="<?= base_url('asset/foto-produk/' . $value->foto) ?>" alt="IMG-INTRO"></a>
                            </div>
                            ...
                            <div class="wrap-text-blo1 p-t-35">
                                ...
                                <?php
										...
										?>
                                <small class="badge badge-success"><?= $value->nama_promo ?>
                                    <?= $value->diskon ?>%</small>
                                <?php
										}
										?>
                                ...
                                <h5>Rp.
                                    <?= number_format($value->harga - (($value->diskon / 100) * $value->harga), 0)  ?>
                                    <?php
											if ($value->diskon != NULL) {
											?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <a href="<?= base_url('Pelanggan/cHome/detail_produk/' . $value->id_produk) ?>"
                                            class="btn3 flex-c-m size18 txt11 trans-0-4" ?>Detail Produk</a>
                                    </div>
                                </div>
